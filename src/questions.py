...
# correct_answers is a list of possible answers

def create_text_input_widget(descriptionText, descriptionCode, correct_answers, last=0):
    ...
    def check_selection(b):
        ...
        with feedback_out:
            clear_output()
            if given_answer in correct_answers:
                print('\x1b[6;30;42m' + "Richtig!" + '\x1b[0m' +"\n") #green color
            elif given_answer!=correct_answers:
                print('\x1b[5;30;41m' + "Falsch!" + '\x1b[0m' +"\n") #red color
        return
